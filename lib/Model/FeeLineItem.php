...
class FeeLineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fee_type' => 'string',
        'fee_charge' => '\Evers\SellingPartnerApi\Model\MoneyType'
    ];
     ...
     * Sets fee_charge
     *
     * @param \Evers\SellingPartnerApi\Model\MoneyType $fee_charge Amount charged to the seller for the specific fee type.
     *
     * @return $this
     */

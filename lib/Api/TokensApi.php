        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SellingPartnerApi\Model\Tokens\CreateRestrictedDataTokenResponse', []),
                ...
                case 400:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SellingPartnerApi\Model\Tokens\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:

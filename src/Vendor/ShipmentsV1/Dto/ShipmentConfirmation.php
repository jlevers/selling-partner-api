...
final class ShipmentConfirmation extends BaseDto
{
     ...
     * @param  string  $shipmentConfirmationDate Date on which the shipment confirmation was submitted.
     ...
     * @param  Carton[]  $cartons A list of the cartons in this shipment.
     * @param  Pallet[]  $pallets A list of the pallets in this shipment.
     */
    public function __construct(
        public readonly string $shipmentIdentifier,
        public readonly string $shipmentConfirmationType,
        public readonly string $shipmentConfirmationDate,
        ...
        public readonly ?array $shippedItems = null,

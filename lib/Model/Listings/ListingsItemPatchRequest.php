...
class ListingsItemPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\SellingPartnerApi\Model\Listings\PatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \SellingPartnerApi\Model\Listings\PatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \SellingPartnerApi\Model\Listings\PatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */

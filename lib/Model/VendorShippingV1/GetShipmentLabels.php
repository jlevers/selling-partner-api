 ...
 */
class GetShipmentLabels extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetShipmentLabels';

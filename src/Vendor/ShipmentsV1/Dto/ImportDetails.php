...
final class ImportDetails extends BaseDto
{
	 ...
	 * @param ?string $estimatedShipByDate Date on which the shipment is expected to be shipped. This value should not be in the past and not more than 60 days out in the future.
	...
	public function __construct(
		...
		public readonly ?string $estimatedShipByDate = null,

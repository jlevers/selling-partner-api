...
use SellingPartnerApi\Seller\MessagingV1\Responses\CreateConfirmOrderDetailsResponse;

/**
 * createConfirmOrderDetails
 */
class CreateConfirmOrderDetails extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        public CreateConfirmOrderDetailsRequest $createConfirmOrderDetailsRequest,
    ...
    {
        return "/messaging/v1/orders/{$this->amazonOrderId}/messages/confirmOrderDetails";
    }

    public function createDtoFromResponse(Response $response): CreateConfirmOrderDetailsResponse
    {
        $status = $response->status();
        $responseCls = match ($status) {
            201, 400, 403, 404, 413, 415, 429, 500, 503 => CreateConfirmOrderDetailsResponse::class,
    ...
    {
        return $this->createConfirmOrderDetailsRequest->toArray();
    }
}

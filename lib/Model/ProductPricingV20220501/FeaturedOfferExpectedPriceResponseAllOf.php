 ...
 */
class FeaturedOfferExpectedPriceResponseAllOf extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeaturedOfferExpectedPriceResponse_allOf';

...
class FulfillmentOrderItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cancelled_quantity' => '\Evers\SellingPartnerApi\Model\Quantity',
        'unfulfillable_quantity' => '\Evers\SellingPartnerApi\Model\Quantity',
        'estimated_ship_date' => '\Evers\SellingPartnerApi\Model\Timestamp',
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\Quantity $cancelled_quantity The item quantity that was cancelled by the seller.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\Quantity $unfulfillable_quantity The item quantity that is unfulfillable.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\Timestamp $estimated_arrival_date The estimated arrival date and time of the item quantity. Note that this value can change over time. If the shipment that contains the item quantity has been cancelled, estimatedArrivalDate is not returned.
     *
     * @return $this
     */

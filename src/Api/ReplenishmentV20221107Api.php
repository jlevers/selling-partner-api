...
class ReplenishmentV20221107Api extends BaseApi
{
    ...
    {
        $response = $this->getSellingPartnerMetricsWithHttpInfo($body);
        return $response;
    }
    ...
    {
        $response = $this->listOfferMetricsWithHttpInfo($body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listOfferMetricsRequest($body = null)
    {
    ...
    {
        $response = $this->listOffersWithHttpInfo($body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listOffersRequest($body = null)
    {

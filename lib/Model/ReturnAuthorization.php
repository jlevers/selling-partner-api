...
class ReturnAuthorization implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'return_to_address' => '\Evers\SellingPartnerApi\Model\Address',
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\Address $return_to_address The address of the Amazon fulfillment center that the return items should be sent to.
     *
     * @return $this
     */

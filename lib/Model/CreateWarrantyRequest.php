...
class CreateWarrantyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets attachments
     *
     * @return \Evers\SellingPartnerApi\Model\Attachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \Evers\SellingPartnerApi\Model\Attachment[]|null $attachments Attachments to include in the message to the buyer. If any text is included in the attachment, the text must be written in the buyer's language of preference, which can be retrieved from the GetAttributes operation.
     *
     * @return self
     */

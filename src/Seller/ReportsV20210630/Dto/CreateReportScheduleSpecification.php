...
final class CreateReportScheduleSpecification extends BaseDto
{
     ...
     * @param  ?string  $nextReportCreationTime The date and time when the schedule will create its next report, in ISO 8601 date time format.
     */
    public function __construct(
        ...
        public readonly ?string $nextReportCreationTime = null,
    ) {
    }
}

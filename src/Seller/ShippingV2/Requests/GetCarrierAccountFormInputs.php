...
use SellingPartnerApi\Seller\ShippingV2\Responses\GetCarrierAccountFormInputsResponse;

/**
 * getCarrierAccountFormInputs
 */
class GetCarrierAccountFormInputs extends Request
{
    ...
    {
        return '/shipping/v2/carrierAccountFormInputs';
    }

    public function createDtoFromResponse(Response $response): GetCarrierAccountFormInputsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => GetCarrierAccountFormInputsResponse::class,

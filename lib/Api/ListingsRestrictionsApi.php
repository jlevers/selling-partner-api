...
class ListingsRestrictionsApi
{
     ...
     * @return \SellingPartnerApi\Model\ListingsRestrictions\RestrictionList
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\ListingsRestrictions\RestrictionList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingsRestrictionsWithHttpInfo($asin, $seller_id, $marketplace_ids, $condition_type = null, $reason_locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SellingPartnerApi\Model\ListingsRestrictions\RestrictionList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApi\Model\ListingsRestrictions\RestrictionList', $response->getHeaders());
                case 400:
                    if ('\SellingPartnerApi\Model\ListingsRestrictions\Error[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApi\Model\ListingsRestrictions\Error[]', $response->getHeaders());
                case 403:
                    if ('\SellingPartnerApi\Model\ListingsRestrictions\Error[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\SellingPartnerApi\Model\ListingsRestrictions\RestrictionList';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListingsRestrictions\RestrictionList',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListingsRestrictions\Error[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

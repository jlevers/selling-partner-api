...
use SellingPartnerApi\Seller\FBAInboundV20240320\Responses\ListPlacementOptionsResponse;

/**
 * listPlacementOptions
 */
class ListPlacementOptions extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ListPlacementOptionsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => ListPlacementOptionsResponse::class,

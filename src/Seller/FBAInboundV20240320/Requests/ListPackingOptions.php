...
use SellingPartnerApi\Seller\FBAInboundV20240320\Responses\ListPackingOptionsResponse;

/**
 * listPackingOptions
 */
class ListPackingOptions extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ListPackingOptionsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => ListPackingOptionsResponse::class,

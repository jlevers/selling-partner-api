 ...
 */
class ListDeliveryWindowOptions extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ListDeliveryWindowOptionsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => ListDeliveryWindowOptionsResponse::class,

...
use SellingPartnerApi\Seller\FBAInboundV20240320\Responses\ListShipmentBoxesResponse;

/**
 * listShipmentBoxes
 */
class ListShipmentBoxes extends Request
{
    ...
    {
        return "/inbound/fba/2024-03-20/inboundPlans/{$this->inboundPlanId}/shipments/{$this->shipmentId}/boxes";
    }

    public function createDtoFromResponse(Response $response): ListShipmentBoxesResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => ListShipmentBoxesResponse::class,

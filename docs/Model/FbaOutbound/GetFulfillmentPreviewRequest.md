...
**address** | [**\Evers\SellingPartnerApi\Model\FbaOutbound\Address**](Address.md) |  |
**items** | [**\Evers\SellingPartnerApi\Model\FbaOutbound\GetFulfillmentPreviewItem[]**](GetFulfillmentPreviewItem.md) | An array of fulfillment preview item information. |
**shipping_speed_categories** | [**\Evers\SellingPartnerApi\Model\FbaOutbound\ShippingSpeedCategory[]**](ShippingSpeedCategory.md) |  | [optional]

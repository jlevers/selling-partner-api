...
final class ProductTypeDefinition extends BaseResponse
{
     ...
     * @param  array  $propertyGroups Mapping of property group names to property groups. Property groups represent logical groupings of schema properties that can be used for display or informational purposes.

...
final class ListOffersRequestFilters extends Dto
{
     ...
     * @param  ?string[]  $deliveriesConditions  A list of delivery condition types to filter the results by. Results are filtered to only include offers with the specified delivery conditions.
     */

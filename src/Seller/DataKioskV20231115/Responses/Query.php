...
final class Query extends BaseResponse
{
     ...
     * @param  string  $createdTime The date and time when the query was created, in ISO 8601 date time format.
     * @param  string  $processingStatus The processing status of the query.
     * @param  ?string  $processingStartTime The date and time when the query processing started, in ISO 8601 date time format.
     * @param  ?string  $processingEndTime The date and time when the query processing completed, in ISO 8601 date time format.

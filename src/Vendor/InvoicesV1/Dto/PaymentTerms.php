...
final class PaymentTerms extends BaseDto
{
     ...
     * @param  float|int  $discountDueDays The number of calendar days from the Base date (Invoice date) until the discount is no longer valid.
     * @param  float|int  $netDueDays The number of calendar days from the base date (invoice date) until the total amount on the invoice is due.
     */
    public function __construct(
        public readonly ?string $type = null,
        public readonly ?string $discountPercent = null,
        public readonly float|int|null $discountDueDays = null,
        public readonly float|int|null $netDueDays = null,
    ) {
    }
}

...
**cpu_speed** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
**cpu_type** | **string** | The CPU type attribute of the item. | [optional]
**creator** | [**\SellingPartnerApi\Model\Catalog\CreatorType[]**](CreatorType.md) | The creator attributes of the item. | [optional]
...
**display_size** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**hard_disk_size** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**languages** | [**\SellingPartnerApi\Model\Catalog\LanguageType[]**](LanguageType.md) | The languages attribute of the item. | [optional]
**legal_disclaimer** | **string** | The legal disclaimer attribute of the item. | [optional]
**list_price** | [**\SellingPartnerApi\Model\Catalog\Price**](Price.md) |  | [optional]
**manufacturer** | **string** | The manufacturer attribute of the item. | [optional]
**manufacturer_maximum_age** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
**manufacturer_minimum_age** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**maximum_resolution** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**optical_zoom** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
**package_dimensions** | [**\SellingPartnerApi\Model\Catalog\DimensionType**](DimensionType.md) |  | [optional]
...
**running_time** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**small_image** | [**\SellingPartnerApi\Model\Catalog\Image**](Image.md) |  | [optional]
**studio** | **string** | The studio attribute of the item. | [optional]
**subscription_length** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
**system_memory_size** | [**\SellingPartnerApi\Model\Catalog\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**weee_tax_value** | [**\SellingPartnerApi\Model\Catalog\Price**](Price.md) |  | [optional]

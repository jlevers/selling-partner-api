 ...
 */
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * @return SellingPartnerApi\Model\NotificationsV1\Subscription
     */

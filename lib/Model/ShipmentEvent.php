...
class ShipmentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_charge_list' => '\Evers\SellingPartnerApi\Model\ChargeComponentList',
        'order_charge_adjustment_list' => '\Evers\SellingPartnerApi\Model\ChargeComponentList',
        'shipment_fee_list' => '\Evers\SellingPartnerApi\Model\FeeComponentList',
        'shipment_fee_adjustment_list' => '\Evers\SellingPartnerApi\Model\FeeComponentList',
        'order_fee_list' => '\Evers\SellingPartnerApi\Model\FeeComponentList',
        'order_fee_adjustment_list' => '\Evers\SellingPartnerApi\Model\FeeComponentList',
        'direct_payment_list' => '\Evers\SellingPartnerApi\Model\DirectPaymentList',
        'posted_date' => '\Evers\SellingPartnerApi\Model\\DateTime',
        'shipment_item_list' => '\Evers\SellingPartnerApi\Model\ShipmentItemList',
        'shipment_item_adjustment_list' => '\Evers\SellingPartnerApi\Model\ShipmentItemList'
    ];
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\ChargeComponentList $order_charge_list A list of order-level charges. These charges are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\ChargeComponentList $order_charge_adjustment_list A list of order-level charge adjustments. These adjustments are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\FeeComponentList $shipment_fee_list A list of shipment-level fees.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\FeeComponentList $shipment_fee_adjustment_list A list of shipment-level fee adjustments.
     *
     * @return $this
     */
     ...
     * Sets order_fee_list
     *
     * @param \Evers\SellingPartnerApi\Model\FeeComponentList $order_fee_list A list of order-level fees. These charges are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\FeeComponentList $order_fee_adjustment_list A list of order-level fee adjustments. These adjustments are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @return \Evers\SellingPartnerApi\Model\DirectPaymentList
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\DirectPaymentList $direct_payment_list A list of transactions where buyers pay Amazon through one of the credit cards offered by Amazon or where buyers pay a seller directly through COD.
     *
     * @return $this
     */
     ...
     *
     * @return \Evers\SellingPartnerApi\Model\ShipmentItemList
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\ShipmentItemList $shipment_item_list shipment_item_list
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\ShipmentItemList $shipment_item_adjustment_list A list of shipment item adjustments.
     *
     * @return $this
     */

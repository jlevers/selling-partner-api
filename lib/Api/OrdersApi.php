...
class OrdersApi
{
    ...
    {
        list($response) = $this->getOrderWithHttpInfo($order_id, $restricted_elements);
        return $response;
    }
    ...
    {
        list($response) = $this->getOrderItemsWithHttpInfo($order_id, $next_token, $restricted_elements);
        return $response;
    }

...
use SellingPartnerApi\Seller\FBAInboundV20240320\Responses\ListInboundPlanBoxesResponse;

/**
 * listInboundPlanBoxes
 */
class ListInboundPlanBoxes extends Request
{
    ...
    {
        return "/inbound/fba/2024-03-20/inboundPlans/{$this->inboundPlanId}/boxes";
    }

    public function createDtoFromResponse(Response $response): ListInboundPlanBoxesResponse|ErrorList
    {

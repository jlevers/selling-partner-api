...
final class PurchaseOrders extends BaseDto
{
	 ...
	 * @param ?string $purchaseOrderDate Purchase order numbers involved in this shipment, list all the PO that are involved as part of this shipment.
	...
	public function __construct(
		...
		public readonly ?string $purchaseOrderDate = null,

...
final class ListingOffersResponse extends Dto
{
     ...
     * @param  ?ListingOffersRequestParams  $request  List of request parameters that can be accepted by `ListingOffersRequest`
     */
    public function __construct(
        public GetOffersResponse $body,
        public ?HttpResponseHeaders $headers = null,
        public ?GetOffersHttpStatusLine $status = null,
        public ?ListingOffersRequestParams $request = null,
    ) {}
}

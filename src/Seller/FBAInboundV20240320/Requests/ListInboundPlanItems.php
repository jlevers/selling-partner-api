...
use SellingPartnerApi\Seller\FBAInboundV20240320\Responses\ListInboundPlanItemsResponse;

/**
 * listInboundPlanItems
 */
class ListInboundPlanItems extends Request
{
    ...
    {
        return "/inbound/fba/2024-03-20/inboundPlans/{$this->inboundPlanId}/items";
    }

    public function createDtoFromResponse(Response $response): ListInboundPlanItemsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => ListInboundPlanItemsResponse::class,

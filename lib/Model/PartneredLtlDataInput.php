...
class PartneredLtlDataInput implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\DateStringType $freight_ready_date The date that the shipment will be ready to be picked up by the carrier.
     *
     * @return $this
     */
     ...
     *
     * @param \Evers\SellingPartnerApi\Model\Amount $seller_declared_value The declaration of the total value of the inventory in the shipment.
     *
     * @return $this
     */

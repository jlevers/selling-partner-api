...
class Reason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'reason_code' => 'string',
        'links' => '\SellingPartnerApi\Model\ListingsRestrictions\Link[]'
    ];
     ...
     * Gets links
     *
     * @return \SellingPartnerApi\Model\ListingsRestrictions\Link[]|null
     */
     ...
     * Sets links
     *
     * @param \SellingPartnerApi\Model\ListingsRestrictions\Link[]|null $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return self
     */

...
class OrdersApi
{
     ...
     * @param  string[] $fulfillment_channels A list that indicates how an order was fulfilled. Filters the results by fulfillment channel. Possible values: MFN (Fulfillment by Amazon); AFN (Fulfilled by the seller). (optional)

...
final class GetSellingPartnerMetricsResponseMetric extends Dto
{
     ...
     * @param  ?float  $shareOfCouponSubscriptions  The percentage of new subscriptions from coupons. Applicable to `PERFORMANCE` `timePeriodType`.
     ...
     * @param  ?float  $signupConversionFor0percentSellerFunding  Percentage of subscriptions from offers with 0% seller-funded discount out of the total number of new orders placed over the past 12 months.
     * @param  ?float  $signupConversionFor5percentSellerFunding  [Applicable only for Sellers] Percentage of subscriptions from offers with 5% seller-funded discount out of the total number of new orders placed over the past 12 months.
     * @param  ?float  $signupConversionFor10percentSellerFunding  [Applicable only for Sellers] Percentage of subscriptions from offers with 10% seller-funded discount out of the total number of new orders placed over the past 12 months.
     * @param  ?float  $signupConversionFor5plusPercentSellerFunding  [Applicable only for Vendors] Percentage of subscriptions from offers with 5% or above seller-funded discount out of the total number of new orders placed over the past 12 months.
     * @param  ?float  $revenuePenetration  The percentage of total program revenue out of total product revenue over a period of time. Applicable to `PERFORMANCE` `timePeriodType`.

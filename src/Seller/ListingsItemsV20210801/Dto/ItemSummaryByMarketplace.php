...
final class ItemSummaryByMarketplace extends BaseDto
{
     ...
     * @param  string  $createdDate Date the listings item was created, in ISO 8601 format.
     * @param  string  $lastUpdatedDate Date the listings item was last updated, in ISO 8601 format.
     ...
     * @param  ItemImage  $itemImage Image for the listings item.
     */
    public function __construct(
        ...
        public readonly ?ItemImage $itemImage = null,

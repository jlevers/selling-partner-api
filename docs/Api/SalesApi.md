# Evers\SellingPartnerApi\SalesApi
...
# **getOrderMetrics**
> \Evers\SellingPartnerApi\Model\GetOrderMetricsResponse getOrderMetrics($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku)
...
$apiInstance = new Evers\SellingPartnerApi\Api\SalesApi(

...
use SellingPartnerApi\Seller\ShippingV2\Responses\GetCollectionFormHistoryResponse;

/**
 * getCollectionFormHistory
 */
class GetCollectionFormHistory extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        public GetCollectionFormHistoryRequest $getCollectionFormHistoryRequest,
        protected ?string $xAmznShippingBusinessId = null,
    ) {}

    public function resolveEndpoint(): string
    {
        return '/shipping/v2/collectionForms/history';
    }

    public function createDtoFromResponse(Response $response): GetCollectionFormHistoryResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => GetCollectionFormHistoryResponse::class,
    ...
    {
        return $this->getCollectionFormHistoryRequest->toArray();
    }

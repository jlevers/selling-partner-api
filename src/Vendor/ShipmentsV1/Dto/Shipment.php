...
final class Shipment extends BaseDto
{
     ...
     * @param  string  $transactionDate Date on which the transportation request was submitted.
     ...
     * @param  ?string  $currentshipmentStatusDate Date and time when the last status was updated.
     * @param  ShipmentStatusDetails[]  $shipmentStatusDetails Indicates the list of current shipment status details and when the last update was received from carrier this is available on shipment Details response.
     * @param  ?string  $shipmentCreateDate The date and time of the shipment request created by vendor.
     * @param  ?string  $shipmentConfirmDate The date and time of the departure of the shipment from the vendor's location. Vendors are requested to send ASNs within 30 minutes of departure from their warehouse/distribution center or at least 6 hours prior to the appointment time at the Buyer destination warehouse, whichever is sooner. Shipped date mentioned in the shipment confirmation should not be in the future.
     * @param  ?string  $packageLabelCreateDate The date and time of the package label created for the shipment by buyer.
     ...
     * @param  PurchaseOrders[]  $purchaseOrders Indicates the purchase orders involved for the transportation request. This group is an array create 1 for each PO and list their corresponding items. This information is used for deciding the route,truck allocation and storage efficiently. This is a mandatory information for Buyer performing transportation from vendor warehouse (WePay/Collect)
     * @param  ?ImportDetails  $importDetails
     * @param  Containers[]  $containers A list of the items in this transportation and their associated inner container details. If any of the item detail fields are common at a carton or a pallet level, provide them at the corresponding carton or pallet level.
    ...
    public function __construct(
        ...
        public readonly ?string $currentshipmentStatusDate = null,
        public readonly ?array $shipmentStatusDetails = null,
        public readonly ?string $shipmentCreateDate = null,
        public readonly ?string $shipmentConfirmDate = null,
        public readonly ?string $packageLabelCreateDate = null,

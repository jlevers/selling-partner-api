 ...
 */
class TransactionStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * @return SellingPartnerApi\Model\VendorTransactionStatusV1\TransactionStatus
     */

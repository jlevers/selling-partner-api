...
class CreateShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\Evers\SellingPartnerApi\Model\Rate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \Evers\SellingPartnerApi\Model\Rate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \Evers\SellingPartnerApi\Model\Rate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */

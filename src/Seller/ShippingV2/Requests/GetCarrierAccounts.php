...
use SellingPartnerApi\Seller\ShippingV2\Responses\GetCarrierAccountsResponse;

/**
 * getCarrierAccounts
 */
class GetCarrierAccounts extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        public GetCarrierAccountsRequest $getCarrierAccountsRequest,
        protected ?string $xAmznShippingBusinessId = null,
    ) {}

    public function resolveEndpoint(): string
    {
        return '/shipping/v2/carrierAccounts';
    }

    public function createDtoFromResponse(Response $response): GetCarrierAccountsResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => GetCarrierAccountsResponse::class,
    ...
    {
        return $this->getCarrierAccountsRequest->toArray();
    }

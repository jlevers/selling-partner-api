...
final class PackageDimensions extends Dto
{
    ...
    /**
     * @param  ?float  $length  A number that represents the given package dimension.
     * @param  ?float  $width  A number that represents the given package dimension.
     * @param  ?float  $height  A number that represents the given package dimension.

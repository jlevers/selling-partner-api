...
**fulfillment_channel** | **string** | The fulfillment channel for the item. Possible values:
...
**shipping_time** | [**\SellingPartnerApi\Model\OldCatalog\ShippingTimeType**](ShippingTimeType.md) |  |

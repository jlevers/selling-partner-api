 ...
 */
class NetworkComminglingTransactionEvent implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * @return SellingPartnerApi\Model\FinancesV0\NetworkComminglingTransactionEvent
     */

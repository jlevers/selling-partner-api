...
class RemovalShipmentItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'quantity' => 'int',
        'revenue' => '\Evers\SellingPartnerApi\Model\Currency',
     ...
     * Sets revenue
     *
     * @param \Evers\SellingPartnerApi\Model\Currency $revenue The total amount paid to the seller for the removed item.
     *
     * @return $this
     */
     ...
     * Sets fee_amount
     *
     * @param \Evers\SellingPartnerApi\Model\Currency $fee_amount The fee that Amazon charged to the seller for the removal of the item. The amount is a negative number.
     *
     * @return $this
     */
     ...
     * Sets tax_amount
     *
     * @param \Evers\SellingPartnerApi\Model\Currency $tax_amount Tax collected on the revenue.
     *
     * @return $this
     */
     ...
     * Sets tax_withheld
     *
     * @param \Evers\SellingPartnerApi\Model\Currency $tax_withheld The tax withheld and remitted to the taxing authority by Amazon on behalf of the seller. If TaxCollectionModel=MarketplaceFacilitator, then TaxWithheld=TaxAmount (except the TaxWithheld amount is a negative number). Otherwise TaxWithheld=0.
     *
     * @return $this
     */

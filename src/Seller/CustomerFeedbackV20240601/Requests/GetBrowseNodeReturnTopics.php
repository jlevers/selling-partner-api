...
use SellingPartnerApi\Seller\CustomerFeedbackV20240601\Responses\BrowseNodeReturnTopicsResponse;
use SellingPartnerApi\Seller\CustomerFeedbackV20240601\Responses\ErrorList;

/**
 * getBrowseNodeReturnTopics
 */
class GetBrowseNodeReturnTopics extends Request
{
    ...
    {
        return "/customerFeedback/2024-06-01/browseNodes/{$this->browseNodeId}/returns/topics";
    }

    public function createDtoFromResponse(Response $response): BrowseNodeReturnTopicsResponse|EmptyResponse|ErrorList
    {
        $status = $response->status();
        $responseCls = match ($status) {
            200 => BrowseNodeReturnTopicsResponse::class,
